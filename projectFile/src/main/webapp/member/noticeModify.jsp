...
function check(){
	  //	alert("테스트");
	   ...
	   if (fm.content.value == ""){
  		...
  		fm.action = "<%=request.getContextPath()%>/member/noticeModifyAction.do?bidx=<%=bv.getBidx()%>";
		...
		<div>
			<table style="text-align:center; border-collapse: collapse; margin-left: auto; margin-right: auto; width:620px;">
				<tr style="">
					...
					<td >
						<input type="text" name="subject" size="103" maxlength="100" value="<%=bv.getSubject() %>" >
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-align: right;">
						<input type="text" name="writer" size="20" maxlength="50" value="<%=bv.getWriter() %>" readonly="readonly" style="text-align: right;"> 
						<!-- readonly="readonly" -->
					</td>
				</tr>
				<!-- <tr>
